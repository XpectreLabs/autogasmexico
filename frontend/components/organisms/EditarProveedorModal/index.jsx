...
import styles from './EditarProveedorModal.module.css';
import Modal from '@mui/material/Modal';
import { Formik, Form } from "formik";
import CircularProgress from '@mui/material/CircularProgress';
import * as Yup from "yup";

export default function EditarProveedorModal({ isOpen, onClose, proveedorData,proveedorIdd }) {
  ...
  return (
    <Formik
        ...
        onSubmit={(values, actions) => {
          ...
          const data = {proveedor_id, name, rfc, direccion, tipo_situacion_fiscal, permiso, phone, email,id};
          setLoading(true);
