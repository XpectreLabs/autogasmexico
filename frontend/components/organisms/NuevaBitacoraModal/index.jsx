...
export default function NuevaBitacoraModal({ isOpen, onClose, fecha_reporte,cargarDataPorPermiso,anio,permiso_id }) {
  ...
  return (
    <Formik
        ...
        onSubmit={(values, actions) => {
          ...
          const tipo_bitacora = 1;
          const data = {...values,user_id, fecha_reporte,tipo_bitacora};
          setLoading(true);
          ...
          .then(function(data) {
            ...
            if(data.message==="success") {
              ...
              setShowAlert(true);
              cargarDataPorPermiso(permiso_id,anio)
